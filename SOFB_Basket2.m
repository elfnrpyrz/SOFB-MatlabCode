...
% This is for condition Basket, counterbalancing 2: MS - MA- BA - BS
%%
clc;
clear all;
close all;
...
sofb_ims={'1.png', '2.png', '3.png', '4.png', '5.png', '6.png', '7.png', '8.png', '9.png', '10.png',...
...
sofb_aud={'1.m4a', '2.m4a', '3.m4a', '5.m4a', '8.m4a', '9.m4a',...
    '10.m4a','11.m4a', '12.m4a', '13.m4a', '14.m4a', '15.m4a', '16.m4a', '17.m4a', ...
    '18.m4a', '19.m4a','21-22.m4a', '23.m4a', '24.m4a', '25.m4a', '26.m4a', ...
    '29.m4a','30.m4a', '31.m4a', '34.m4a', '36.m4a'};
...
while keepgoing ==1
    ...
    vismystory(sofb_ims{22}, sofb_aud{22})
    ...
    vismystory(sofb_ims{22}, sofb_aud{23})
    
    % Step 31 - Sammy Memory C
    
    feeds(sofb_aud{24}) % Do you remember...
    ...
    vismystory(sofb_ims{22}, q_aud{8}) % where did Anne put the bunny?
   ...
   % Step 36 Anne 1st Order Belief
    ...
    vismystory(sofb_ims{3},gap_aud{3}) % When Anne comes back...
    ...
    vismystory(sofb_ims{22}, sofb_aud{26}) % i have one last Question for you
